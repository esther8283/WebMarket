...
//		Java에서 데이터 처리를 쉽게 하기 위해서 미리 만들어놓은 자료 구조를 컬렉션 프레임워크라고 함
//		컬렉션은 크게 2가지로 나누어짐 (Collection, Map)
//		Collection은 자바스크립트의 배열과 비슷한 방식(ArrayList를 가장 많이 사용)
//		Map은 자바스크립트의 object와 비슷한 방식(HashMap을 가장 많이 사용)
...
//		clear() : ArrayList 객체에 저장된 모든 데이터 삭제
		...
		System.out.println("List를 사용한 과일목록의 크기 : " + listFruit.size());
		System.out.println("배열을 사용한 과일 목록의 크기 : " + arrFruit.length);
		
		
		System.out.println("----- 배열과 리스트에 데이터입력 -----");
		listFruit.add("수박");
		listFruit.add("한라봉");
		listFruit.add("딸기");
